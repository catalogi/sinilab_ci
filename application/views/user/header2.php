...
<head>
  ...
  <!-- <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous"> -->
	...
	<script src="https://kit.fontawesome.com/6e99d705ea.js" crossorigin="anonymous"></script>
...
<body>
    ...
    <nav class="navbar navbar-expand-sm fixed-top py-3">
        <div class="container-fluid">
			...
			<div class="bt">
				<img alt="image" src="<?= base_url() ?>/assets/img/avatar-1.png" class="rounded-circle mr-1 avatar">
			</div>
        </div>
    </nav>
</header>
